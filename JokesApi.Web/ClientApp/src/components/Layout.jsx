            ...
            <header>
                <nav className="navbar navbar-expand-sm navbar-dark fixed-top bg-dark border-bottom box-shadow">
                    <div className="container">
                        <a className="navbar-brand">JokesApi</a>
                        ...
                        <div className="navbar-collapse collapse d-sm-inline-flex justify-content-between">
                            <ul className="navbar-nav flex-grow-1">
                                ...
                                <li className="nav-item"><Link to="/search" className='nav-link text-light'>Search Jokes</Link></li>
                                ...
                                {user && <li className="nav-item"><Link to="/faves" className='nav-link text-light'>My Favorites</Link></li>}
                            </ul>
                        </div>
                    </div>
                </nav>
